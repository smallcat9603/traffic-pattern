...
plot  '/Users/smallcat/Documents/GitHub/traffic-pattern/gnuplot/slot-optimization-mesh-2d-4096.txt' using ($2):xtic(1) title "baseline", '' using ($3) title "src\\_greedy", '' using ($4) title "src\\_polling", '' using ($5) title "hcLtoS\\_greedy", '' using ($6) title "hcLtoS\\_polling", '' using ($7) title "hcStoL\\_greedy", '' using ($8) title "hcStoL\\_polling"

#set terminal png         # gnuplot recommends setting terminal before output
#set output '/Users/smallcat/Documents/GitHub/traffic-pattern/gnuplot/slot-optimization-mesh-2d-4096.png'  

set term post eps color "GothicBBB-Medium-RKSJ-H, 20"      
set output '/Users/smallcat/Documents/GitHub/traffic-pattern/gnuplot/slot-optimization-mesh-2d-4096.eps'  
replot
