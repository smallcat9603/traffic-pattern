...
plot  '/Users/smallcat/gnuplot/adaptive-routing-3d-torus-64.txt' using ($2):xtic(1) title "dimension order routing", '' using ($3) title "dimension adaptive routing", '' using ($4) title "minimal oblivious routing"

#set terminal png         # gnuplot recommends setting terminal before output
#set output '/Users/smallcat/gnuplot/adaptive-routing-3d-torus-64.png'  
 
set terminal postscript eps 20
#set term post eps color     
set output '/Users/smallcat/gnuplot/adaptive-routing-3d-torus-64.eps'  
replot
